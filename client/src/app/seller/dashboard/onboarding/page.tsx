				...
				<main className="flex-1 p-8 md:p-12">
					<div className="max-w-4xl mx-auto">
						...
						<p className="text-neutral-400 mb-8">
							Complete all required documents to start trading on
							our platform
						</p>
						...
						{onboardingStatus && (
							<div className="bg-neutral-900 rounded-xl p-6 mb-8 border border-neutral-800">
								...
								<div className="text-sm text-neutral-400">
									...
									{onboardingStatus.totalRequirements}{" "}
									documents completed
								</div>
							</div>
						)}
						...
						<div className="grid gap-6">
							{documentTypes.map((doc) => {
								const isCompleted =
									onboardingStatus?.onboarding.requirements[
										doc.key
									]?.completed || false;
						...
						onboardingStatus.onboarding.status === "pending" ? (
							<div className="mt-8 bg-yellow-900/20 border border-yellow-700 rounded-xl p-6 text-center">
								...
								<p className="text-neutral-300">
									Your onboarding has been submitted and is
						  ...
						  onboardingStatus.progress === 100 ? (
							<div className="mt-8 text-center">
								...
								<p className="text-neutral-400 text-sm mt-2">
									All documents uploaded. Submit for admin
									review to complete onboarding.
								</p>
							</div>
						) : null}
						...
						{onboardingStatus &&
							onboardingStatus.onboarding.status ===
								...
								<div className="mt-8 bg-green-900/20 border border-green-700 rounded-xl p-6 text-center">
									...
									<p className="text-neutral-300">
										Congratulations! Your onboarding has
										been approved. You can now start trading
										on our platform.
									</p>
								</div>
							)}
						...
						{onboardingStatus &&
							onboardingStatus.onboarding.status ===
								...
								<div className="mt-8 bg-red-900/20 border border-red-700 rounded-xl p-6 text-center">
									...
									<p className="text-neutral-300">
										Your onboarding has been rejected.
						...
						{onboardingStatus &&
							onboardingStatus.onboarding.status ===
								...
								<div className="mt-8 text-center">
									...
									<p className="text-neutral-400 text-sm mt-2">
										You can update your documents and
